...
//      menuDiv.innerHTML = ""; // Clear previous images to avoi
...
//         </div>`;   // to add the details to the image
...
// };  // to allow updating of the details
// function addRamen() {
//     const inputs = document.querySelectorAll(".input");
...
//     const inputs = document.querySelectorAll(".input");
//     const ramenToDelete = inputs[0].value; 
    
//     const index = ramens.findIndex(ramen => ramen.name === ramenToDelete);
